...
% FIXME: Reveiw if waypoints should be independent list
...
greedy_tsp(Orig, Route, CompleteRoute, Distance) :-
    ...
    route_with_waypoints(Route, CompleteRoute), !.
